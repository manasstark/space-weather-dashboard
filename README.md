...
│
├── dashboard/
│   ├── home.py                         # Streamlit entry point: page routing, dialogs, Home/Photosphere/Heliosphere/
│   │                                   #   Geospace/Analytics page bodies, Event Explorer, Heliomap, Saved Events/Library
