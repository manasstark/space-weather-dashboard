...
def predict_kp_interval(dataset: str = "analytics") -> dict:
    ...
    return {
        ...
        "metrics": {
            ...
            "mae": meta["mae"],
            "rmse": meta["rmse"],
            # Walk-forward CV stability metrics (None for any model trained
            # before this field existed) — see swdss.models.train._fit_best.
            "cv_r2_mean": meta.get("cv_r2_mean"),
            "cv_r2_std": meta.get("cv_r2_std"),
            "cv_mae_mean": meta.get("cv_mae_mean"),
            "cv_mae_std": meta.get("cv_mae_std"),
            "cv_rmse_mean": meta.get("cv_rmse_mean"),
            "cv_rmse_std": meta.get("cv_rmse_std"),
            "cv_n_folds": meta.get("cv_n_folds"),
        },
